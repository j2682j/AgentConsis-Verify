        ...
        return "\n".join(
            [
                ...
                *source_lines,
                ...
                "- A fact assigned to Current Goal must express that goal's exact relation and goal_id.",
                "- Keep event roles distinct: nominated_by is not promoted_by, reviewed_by, illustrated_by, or supported_by.",
                "- A person mention, image credit, editor signature, or promotion log is not evidence for another relation.",
